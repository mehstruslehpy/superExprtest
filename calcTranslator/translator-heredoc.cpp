...
int main()
{
    ...
    while (!last)
    {
        ...
        if (!last)
        {
            cout << "FILE:\tc #more formulas" << endl;
            outfile << "\tc #more formulas" << endl;
        }
        else
        {
            cout << "FILE:\tq #last formula" << endl;
            outfile << "\tq #last formula" << endl;
        }
...
int parseFormula(ofstream& fout,const string& str, int start, int stop)
{
    ...
    if ((oploc = isExistential(str))!=-1)
    {
        ...
        cout << "FILE:\t1 #unary" << endl;
        fout << "\t1 #unary" << endl;
        cout << "FILE:\te #existential" << endl;
        fout << "\te #existential" << endl;
        cout << "FILE:\t" <<str.substr(5,endparen-5)<< endl;
        fout << "\t" <<str.substr(5,endparen-5)<< endl;
    ...
    else if ((oploc = isUniversal(str))!=-1)
    {
        ...
        cout << "FILE:\t1 #unary" << endl;
        fout << "\t1 #unary" << endl;
        cout << "FILE:\tu #universal" << endl;
        fout << "\tu #universal" << endl;
        cout << "FILE:\t" <<str.substr(4,endparen-4)<< endl;
        fout << "\t" <<str.substr(4,endparen-4)<< endl;
        string sub = str.substr(endparen+1,str.size());
    ...
    else if (isVariable(str)!=-1)
    {
        ...
        cout << "FILE:\t1 #unary" << endl;
        fout << "\t1 #unary" << endl;
        cout << "FILE:\tv #variable" << endl;
        fout << "\tv #variable" << endl;
        ...
        //endparen = matchEndParens(str,0);
        cout << "FILE:\t" << str.substr(0,startparen) << endl;
        fout << "\t" << str.substr(0,startparen) << endl;
        cout << "FILE:\t"<< str.substr(startparen+1,str.size()-startparen-2) << endl;
        fout << "\t"<<str.substr(startparen+1,str.size()-startparen-2) << endl;
        return 1;
    }
...
void twoplaceemit(ofstream& fout,const string& str,int start,int oploc, const string& op)
{
    ...
    cout << "FILE:\t2 #binary" << endl;
    fout << "\t2 #binary" << endl;
    cout << "FILE:\t  #operator" << op << endl;
    fout << "\t" << op <<" #operator" << endl;

...
int main()
{
    ...
    outfile << "set continuevar 1;" <<endl;
    outfile << "while {$continuevar==1} {" << endl;
    outfile << "    expect {" << endl;
    outfile << "    \"Continue inferences or quit\" {" << endl;
    outfile << "        send \"c\\r\";" << endl;
    outfile << "        continue;" << endl;
    outfile << "    }" << endl;
    outfile << "    default {" << endl;
    outfile << "        puts \"EXPECT-DEBUG: did not get prompt\";" << endl;
    outfile << "        #interact;" << endl;
    outfile << "        exit;" << endl;
    outfile << "        }" << endl;
    outfile << "    }" << endl;
    outfile << "}" << endl;

    cout << "FILE: set continuevar 1;" <<endl;
    cout << "FILE: while {$continuevar==1} {" << endl;
    cout << "FILE:     expect {" << endl;
    cout << "FILE:         \"Continue inferences or quit\" {" << endl;
    cout << "FILE:             send \"c\\r\";" << endl;
    cout << "FILE:             continue;" << endl;
    cout << "FILE:         }" << endl;
    cout << "FILE:         default {" << endl;
    cout << "FILE:             puts \"EXPECT-DEBUG: did not get prompt\";" << endl;
    cout << "FILE:             #interact;" << endl;
    cout << "FILE:             exit;" << endl;
    cout << "FILE:         }" << endl;
    cout << "FILE:     }" << endl;
    cout << "FILE: }" << endl;
...
void expectPreamble(ofstream& fout)
{
    ...
    cout << "FILE: #spawn gdb -ex run ../main" << endl;
    cout << "FILE: spawn ../main" << endl;
    fout << "#spawn gdb -ex run ../main" << endl;
    fout << "spawn ../main" << endl;
    fout << "send \"p\\r\"; #this program is using proof mode" << endl;
}
int isQuantified(const string& str)
{
